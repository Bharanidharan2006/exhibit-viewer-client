  ...
  useEffect(() => {
    ...
    async function init() {
      ...
      loader.load(template.glbFile, (gltf) => {
        ...
        // Place player using bounding box (same logic as working vanilla script)
        ...
        EYE_HEIGHT = size.y * 0.37;

        // Spawn at front-centre of gallery, 15% in from the front wall
        const spawnX = center.x;
        const spawnZ = box.max.z - size.z * 0.15;
